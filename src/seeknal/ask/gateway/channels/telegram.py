...
_TELEGRAM_FORMAT_HINT = (
    ...
    "'tambahkan', 'edit', or modify content after a Proof document was just "
    "published, they mean to update THAT document. Use read_proof_document "
    "with the share URL from your previous response to fetch current content, "
    "then use edit_proof_document to append or modify it. Never create seeknal "
    "pipeline nodes or start a new analysis unless explicitly asked.]\n"
