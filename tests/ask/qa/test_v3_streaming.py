...
class TestStreamingRendering:
    ...
    async def test_stream_simple_query(self, qa_project):
        ...
        answer = await stream_ask(
            agent, deps, message_history, "How many customers?", console
        )
    ...
    async def test_stream_shows_tool_calls(self, qa_project):
    ...
    async def test_stream_multistep_analysis(self, qa_project):
    ...
    async def test_quiet_mode_uses_sync(self, qa_project):
...
class TestStreamingMultiTurn:
    ...
    async def test_two_turn_streaming_chat(self, qa_project):
