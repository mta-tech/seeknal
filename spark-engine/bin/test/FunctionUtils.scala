...
object FunctionUtils {
  /**
    ...
    * @param functionName the name of aggregate function to be applied
    * @param inputs the input columns to be aggregated
    * @param defaultValue the default value of the aggregation
    */
  def applyAggregateFunction(
    spark: SparkSession,
    functionName: String,
    inputs: Seq[Column],
